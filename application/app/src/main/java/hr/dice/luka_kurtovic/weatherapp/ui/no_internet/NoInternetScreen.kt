package hr.dice.luka_kurtovic.weatherapp.ui.no_internet
...
/**
 * Presented to the user when there is no internet connection.
 *
...
fun NoInternetScreen(
    ...
    Column(
        ...
        Icon(
            imageVector = ImageVector.vectorResource(id = R.drawable.ic_no_internet),
